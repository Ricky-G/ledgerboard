...
Kanban Ledger is a local-first VS Code board whose source of truth is three readable Markdown files.
...
![Kanban Ledger board](images/board.png)
...
2. Run **Kanban Ledger: Initialize Board in Folder** from the Command Palette.
...
Run **Kanban Ledger: Open Board** whenever you want to return. In a multi-root workspace, Kanban
...
Existing boards begin with honest baseline observations. Kanban Ledger never invents old creation or
completion dates.
...
| Command | Purpose |
|---|---|
| **Kanban Ledger: Initialize Board in Folder** | Create the missing Markdown bundle files |
| **Kanban Ledger: Open Board** | Discover and open a board in the workspace |
| **Kanban Ledger: Add Outcome** | Open the board directly in the new-outcome dialog |
| **Kanban Ledger: Validate Board Bundle** | Validate syntax, entities, WIP, history, and round-trip safety |
| **Kanban Ledger: Open Board Standard** | Open the complete format and agent-generation contract |
...
Kanban Ledger does not collect telemetry and does not make network requests. It reads and writes only
